...
static Key keys[] = {
    ...
    { 0,                   XF86XK_AudioLowerVolume,spawn,            SHCMD("~/scripts/app-starter.sh set_vol down &") },
    { 0,                   XF86XK_AudioMute,       spawn,            SHCMD("~/scripts/app-starter.sh set_vol mutevol &") },
    { 0,                   XF86XK_AudioRaiseVolume,spawn,            SHCMD("~/scripts/app-starter.sh set_vol up &") },
    { 0,                   XF86XK_MonBrightnessDown,spawn,            SHCMD("~/scripts/app-starter.sh set_light down &") },
    { 0,                   XF86XK_MonBrightnessUp, spawn,            SHCMD("~/scripts/app-starter.sh set_light up &") },
